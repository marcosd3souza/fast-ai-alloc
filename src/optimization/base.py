...
class BaseOptimizer:
    def __init__(self,
                 n_requests: int,
                 n_nodes: int,
                 memory_consumption: np.ndarray,
                 cpu_consumption: np.ndarray,
                 memory_classification: np.ndarray,
                 cpu_classification: np.ndarray):
    ...
    def calc_fitness(self, alloc_suggestion, is_suggestion_in_mat_format=False, metric: str = 'multi'):
